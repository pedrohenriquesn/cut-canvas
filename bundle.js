...
function mouseMoveAction() {
    if (sessionStorage.getItem('dragMouse') == 'true') {
        ...
        var diffX = -(parseInt(sessionStorage.getItem('initClientX')) - parseInt(event.clientX));
        var diffY = -(parseInt(sessionStorage.getItem('initClientY')) - parseInt(event.clientY));

        switch (sessionStorage.getItem('dataMove')) {
            case "full-box":

                var startClickX = sessionStorage.getItem('initClientX');
                var startClickY = sessionStorage.getItem('initClientY');

                // MOVIMENTACAO NO EIXO (Y)
                var borderTopBox = parseInt(sessionStorage.getItem('currentBorderTop')) + diffY;
                $('.box-size').css('border-top', '' + borderTopBox + 'px solid rgba(99, 102, 104, 0.63)');
                var atualTop = parseInt(sessionStorage.getItem('currentBorderBottom')) - diffY;
                $('.box-size').css('border-bottom', '' + atualTop + 'px solid rgba(99, 102, 104, 0.63)');

                // MOVIMENTACAO NO EIXO (X)
                var borderLeft = parseInt(sessionStorage.getItem('currentBorderLeft')) + diffX;
                $('.box-size').css('border-left', '' + borderLeft + 'px solid rgba(99, 102, 104, 0.63)');
                var atualLeft = parseInt(sessionStorage.getItem('currentBorderRight')) - diffX;
                $('.box-size').css('border-right', '' + atualLeft + 'px solid rgba(99, 102, 104, 0.63)');

                break;
            case "top-box":
                var currentBorderTop = parseInt(sessionStorage.getItem('currentBorderTop'));
                var valorTop = currentBorderTop + diffY;
                $('.box-size').css('border-top', '' + valorTop + 'px solid rgba(99, 102, 104, 0.63)');
                var currentTop = parseInt(sessionStorage.getItem('currentBorderBottom'));
                var newBorderTop = currentTop - diffY;
                $('.box-size').css('border-bottom', '' + newBorderTop + 'px solid rgba(99, 102, 104, 0.63)');
                break;
            case "left-box":
                var currentBorderLeft = parseInt(sessionStorage.getItem('currentBorderLeft'));
                var valorLeft = currentBorderLeft + diffX;
                $('.box-size').css('border-left', '' + valorLeft + 'px solid rgba(99, 102, 104, 0.63)');
                var currentLeft = parseInt(sessionStorage.getItem('currentBorderRight'));
                var newBorderLeft = currentLeft - diffX;
                $('.box-size').css('border-right', '' + newBorderLeft + 'px solid rgba(99, 102, 104, 0.63)');
                break;
            case "right-box":
                var currentSizeRight = parseInt(sessionStorage.getItem('currentSizeRight'));
                var valorRight = currentSizeRight + diffX;
                $('.box-size').css('width', '' + valorRight + 'px');
                var currentRight = parseInt(sessionStorage.getItem('currentBorderRight'));
                var newBorderRight = currentRight - diffX;
                $('.box-size').css('border-right', '' + newBorderRight + 'px solid rgba(99, 102, 104, 0.63)');
                break;
            case "bottom-box":
                var currentSizeHeight = parseInt(sessionStorage.getItem('currentSizeHeight'));
                var valorHeight = currentSizeHeight + diffY;
                $('.box-size').css('height', '' + valorHeight + 'px');
                var currentBottom = parseInt(sessionStorage.getItem('currentBorderBottom'));
                var newBorderBottom = currentBottom - diffY;
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!./boxes.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!./boxes.css");
...
var mouseDown = __webpack_require__(2);
var mouseMove = __webpack_require__(3);
...
// module
exports.push([module.i, ".art-box { padding: 10px; }\n.art-image { position: relative; }\n\n.box-size {\n    height: 300px;\n    width: 300px;\n    z-index: 99999;\n    position: absolute;\n    border-right: 200px solid rgba(99, 102, 104, 0.63);\n    border-bottom: 100px solid rgba(99, 102, 104, 0.63);\n    border-left: 200px solid rgba(99, 102, 104, 0.63);\n    border-top: 100px solid rgba(99, 102, 104, 0.63);\n    cursor: crosshair;\n}\n\n.sizeY {\n    background-color: #3E6892;\n    width: 100%;\n    height: 5px;\n}\n.re-top { cursor: s-resize; }\n.re-bottom {\n    bottom: -5px;\n    position: absolute;\n    cursor: n-resize;\n}\n\n.sizeX {\n    background-color: #3E6892;\n    height: 100%;\n    width: 5px;\n}\n.re-right {\n    float: right;\n    cursor: w-resize;\n\n}\n.re-left {\n    float: left;\n    cursor: e-resize;\n}", ""]);
